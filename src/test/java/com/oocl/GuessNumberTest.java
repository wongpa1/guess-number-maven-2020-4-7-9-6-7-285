...
public class GuessNumberTest {
    ...
    public void should_output_xAxB_for_normal_user_input() {
        ...
        Assert.assertEquals("4A0B", guessNumber.play());

    }

    @Test
    public void should_output_ITNT_MESSAGE_for_random_number() {
        GuessNumber guessNumber = new GuessNumber();
        Assert.assertEquals("Random number is generated. Game Start!", guessNumber.initial());
    }

    @Test
    public void should_output_error_message_for_invalid_input() {
        GuessNumber guessNumber = new GuessNumber();
        guessNumber.initial();
